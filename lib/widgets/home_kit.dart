...
class SummaryTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final share = percent.clamp(0.0, 1.0);
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: [colour.withValues(alpha: 0.13), colour.withValues(alpha: 0.04)],
        ),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: colour.withValues(alpha: 0.18), blurRadius: 8, offset: const Offset(0, 3))],
                ),
                child: Icon(icon, color: colour, size: 17),
              ),
              const Spacer(),
              Text('${(share * 100).round()}%',
                  style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: colour)),
            ],
          ),
          const SizedBox(height: 10),
          FittedBox(
            ...
            child: Text('$value',
                style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w900, height: 1, color: AppColors.text)),
          ),
          const SizedBox(height: 2),
          Text(label,
              maxLines: 1,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: const [BoxShadow(color: Color(0x0D0F1B3D), blurRadius: 14, offset: Offset(0, 6))],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        mainAxisSize: MainAxisSize.min,
        children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    ...
                    colors: [colour.withValues(alpha: 0.22), colour.withValues(alpha: 0.08)],
                  ),
                ),
                child: Icon(icon, color: colour, size: 17),
              ),
          ...
          FittedBox(
            ...
            child: Text(value,
                maxLines: 1,
                style: const TextStyle(
                    fontSize: 21, fontWeight: FontWeight.w900, height: 1.1, color: AppColors.text)),
          ),
          if (change != null) ...[
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(up ? Icons.trending_up_rounded : Icons.trending_down_rounded, size: 13, color: tone),
                      const SizedBox(width: 3),
