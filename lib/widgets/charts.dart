            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: const LinearGradient(
                        colors: [AixoloColors.teal, AixoloColors.primary],
                  ...
                  Text(labels[i], style: const TextStyle(fontSize: 10, color: AixoloColors.muted)),
                ],
              ),
            ),
        ],
        ...
        children: [
          SizedBox(
            ...
            child: CircularProgressIndicator(
              ...
              valueColor: const AlwaysStoppedAnimation(AixoloColors.primary),
            ),
          ),
